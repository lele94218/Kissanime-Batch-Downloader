...
var episodeLinks = $('.listing.listing8515.full a').map(function(i,el) { return $(el).attr('href'); });
var episodeNames = $('.listing.listing8515.full a').map(function(i,el) { return $.trim( $(el).html() ); });
