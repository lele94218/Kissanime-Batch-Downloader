...
var rootUrl = 'http://kisscartoon.io'
var URL = window.location.origin
// END CONFIG


var episodeLinks = $('.listing a').map(function(i,el) { return $(el).attr('href'); });
var episodeNames = $('.listing a').map(function(i,el) { return $.trim( $(el).html() ); });
